...
MediaDialog.prototype.insertAndClose = function(image) {
...
MediaDialog.prototype.insertImage = function(thumbspan, imgsrc, alttext) {
	...
	if (win != undefined) {
		...
		if (typeof(win.MediaDialog) != "undefined") {
			if (win.MediaDialog.getImageData) {
				win.MediaDialog.getImageData();
			}
			if (win.MediaDialog.showPreviewImage) {
				win.MediaDialog.showPreviewImage(URL);
			}
...
MediaDialog.prototype.insertThumbnail = function(anchor, imgsrc){
...
MediaDialog.prototype.loadresizer = function(imagesrc) {
...
// pre-cache an image
MediaDialog.prototype.loadImage = function(img) { 
...
MediaDialog.prototype.checkImgLoad = function(preImage) {
...
MediaDialog.prototype.checkLoad = function(preImage) {
	var _this = this;
	if (preImage.complete) { 
...
// show resizer image
MediaDialog.prototype.showResizeImage = function(preImage) {
...
MediaDialog.prototype.insertResizeImage = function(){
...
MediaDialog.prototype.saveImgSize = function() {
...
MediaDialog.prototype.deleteImage = function(imageid) {
	this.deleteAsset(imageid);
}	

MediaDialog.prototype.doSearch = function(e, el){
	// enter pressed
	if (e.keyCode == 13) {
