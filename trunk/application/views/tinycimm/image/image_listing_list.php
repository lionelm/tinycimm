...
<li><span id="image-<?=$image['id'];?>" onclick="ImageDialog.insertPreviewImage('<?=$image['filename'];?>', '<?=$image['alttext'];?>');" style="cursor:pointer;display:block" title="insert image" onMouseOver="this.style.color='#000066';this.style.background='#EEEEEE';" onMouseOut="this.style.color='#000000';this.style.background='#FFFFFF';">
